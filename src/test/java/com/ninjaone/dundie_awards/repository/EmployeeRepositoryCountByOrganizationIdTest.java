...
@Slf4j
class EmployeeRepositoryCountByOrganizationIdTest {
    ...
    @Test
    void shouldCountEmployeesByOrganizationId() {
        int count = employeeRepository.countByOrganizationId(1L);
        log.info("Count query returned: {}", count);
